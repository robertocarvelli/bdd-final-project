...
class TestProductModel(unittest.TestCase):
    ...
    def test_read_a_product(self):
        ...
        new_product.id = None
        new_product.create()
        saved_prod = Product.find(new_product.id)
        self.assertIsNotNone(new_product.id)
        self.assertEqual(new_product.name, saved_prod.name)
        self.assertEqual(new_product.description, saved_prod.description)
        self.assertEqual(Decimal(new_product.price), saved_prod.price)
